...
def replace_once(label: str, needle: str, replacement: str) -> None:
    global source
...
def replace_exact_count(label: str, needle: str, replacement: str, expected: int) -> None:
    global source
    count = source.count(needle)
    if count != expected:
